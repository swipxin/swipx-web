...
export function Home() {
  const { state, navigateTo, updateUser } = useApp()
  const { user } = state
        ...
        <Card className="glass p-4">
          ...
          <div className="flex flex-wrap gap-2">
            <Badge variant="secondary" className="gap-1">
              ...
              {user.isPremium ? 'Selected: India' : 'Global matching'}
            </Badge>
            <Badge variant="secondary" className="gap-1">
        ...
        <div className="grid grid-cols-2 gap-4">
          <Card className="glass p-4 space-y-3">
            ...
            <Button
              variant="outline"
              size="sm"
              onClick={() => user.isPremium ? navigateTo('country-select') : navigateTo('plans')}
